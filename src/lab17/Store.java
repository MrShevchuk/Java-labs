...
public class Store {
    ...
    public Store(String nameStore, String urlStore) {
    }
        ...
        for (User user : userList(users)) {
            if (user.isLoginCorrect(login)) {
                if (user.isPasswordCorrect(passwords)) {
                    authorizedUser = user;
                    System.out.println("Authorization's complete. ");
                    return true;
                } else break;
            }
        }
        System.out.println("Wrong login or password. Please check and try again. ");
        System.out.println("================   =============   =============");
        return false;
    }
